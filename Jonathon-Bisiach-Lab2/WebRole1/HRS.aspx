<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HRS.aspx.cs" Inherits="WebRole1.HRS" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <p>
            <asp:Button ID="BtnGet" runat="server" OnClick="Offer" Text="Get Offer">
            </asp:Button>
        </p>
        ...
        <p>
            <asp:Button ID="goOn" runat="server" OnClick="Continue" Text="Continue" Visible="false">
            </asp:Button>
        </p>
